...
def get_metacluster_network():
    """gets network of cluster co-occurrences generated by semantic clustering approaches

    Returns:
        nx.Graph: cluster co-occurrences generated by semantic clustering approaches
    """
    return download_obj(BUCKET_NAME, "outputs/meta_cluster_network.pkl")