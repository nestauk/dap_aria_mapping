...
def main(
    ...
    topics_df = nu.preprocess_topics_dict(topics_dict, works_df, "work_id", "publication_year")
    logging.info(f"Using {len(topics_df)} papers with sufficient data for novelty calculation")
    ...
    export_path = OUTPUT_FOLDER / f"openalex_novelty_{taxonomy_level}.csv"
