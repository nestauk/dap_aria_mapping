...
n_components = np.arange(500, 10_000, 500)
models = {
    n: GaussianMixture(
        n_components=n,
...
fig.savefig(FOLDER / "gmm.png", dpi=300)
...
for ncomp in range(5, 55, 5):
    ...
    n_components = np.arange(1000, 10_000, 1000)
    models = {
        n: GaussianMixture(
            n_components=n,
            covariance_type="diag",
    ...
    fig.savefig(FOLDER / f"gmm_pca_{str(ncomp)}.png", dpi=300)
