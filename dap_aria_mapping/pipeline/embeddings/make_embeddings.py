...
from dap_aria_mapping.getters.openalex import get_openalex_entities, get_patent_entities
...
parser.add_argument(
    ...
    default=60, 
    type=int, 
    help="Minimum frequency for entities"
)
parser.add_argument(
    "--max_freq", 
    default=100, 
    type=int, 
    help="Maximum frequency for entities"
)
parser.add_argument(
    "--method",
    default="percentile",
...
parser.add_argument(
    "--model", 
    default=MODEL_NAME, 
    help="Name for the model to use"
)
parser.add_argument(
    "--device", 
...
entities = openalex_entities + patent_entities
...
embeddings = pipe(
    entities,
    encoder.encode,
    lambda embeds: dict(zip(entities, embeds))
)
