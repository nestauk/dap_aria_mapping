...
def tax_chisq(tax: pd.DataFrame, tax_name: str, metrics: dict) -> dict:
    ...
    for i in range(0, len(tax.columns)):
        ...
        metrics[tax_name]["level_{}".format(i+1)] = chisquare(f_obs,f_exp)[0]
